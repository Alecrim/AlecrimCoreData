...
extension FetchRequestController {
    ...
    @discardableResult
    public func bind(to tableView: UITableView, rowAnimation: UITableView.RowAnimation = .fade, sectionOffset: Int = 0, cellConfigurationHandler: ((UITableViewCell, IndexPath) -> Void)? = nil) -> Self {
        //
